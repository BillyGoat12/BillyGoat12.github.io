...
function greeter(hour) {
    ...
    if(hour <= 11){// check if hour is equal to or less then 11
        return console.log("Good Morning!");// return the string good morning
    }else if(hour >= 12 && hour <= 16){// return the string being log to the console
        return console.log("Good Afternoon!");// check if hour is between 12 - 16
    }else if(hour <= 21){// checking if hour is less then 21
        return console.log("Good Evening!");// return the string being log to the console
    }
    
    
    return console.log("Good Night!");// return the string being log to the console
